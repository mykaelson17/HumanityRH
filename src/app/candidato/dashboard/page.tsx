  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-4 gap-4 mb-8">
        <Link href="/candidato/dashboard/candidaturas" style={{ display: "block" }}>
          <Card className="text-center hover:bg-gray-50 transition-colors cursor-pointer h-full">
        ...
        <Link href="/candidato/dashboard/candidaturas?status=SCREENING" style={{ display: "block" }}>
          <Card className="text-center hover:bg-gray-50 transition-colors cursor-pointer h-full">
        ...
        <Link href="/candidato/dashboard/candidaturas?status=INTERVIEW" style={{ display: "block" }}>
          <Card className="text-center hover:bg-gray-50 transition-colors cursor-pointer h-full">
        ...
        <Link href="/candidato/dashboard/candidaturas?status=APPROVED" style={{ display: "block" }}>
          <Card className="text-center hover:bg-gray-50 transition-colors cursor-pointer h-full">
